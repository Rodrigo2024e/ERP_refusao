...
public class PartnerDTO {
	...
	@NotBlank(message = "O campo IE é obrigatório")
	private String ie;
	...
	public PartnerDTO(Long id, String name, String email, String cellPhone, String telephone, String cnpj, String ie,
			Boolean supplier, Boolean client, Boolean active) {
		this.id = id;
		this.name = name;
		this.email = email;
