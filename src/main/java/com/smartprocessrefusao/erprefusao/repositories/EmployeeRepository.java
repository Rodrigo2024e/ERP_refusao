...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
	...
	@Query(value = """
			...
			""", countQuery = """
			    ...
			    AND (:name IS NULL OR LOWER(p.name) LIKE LOWER(CONCAT('%', :name, '%')))
			""", nativeQuery = true)
	Page<EmployeeDepartamentReportProjection> searchEmployeeByDepartament(@Param("name") String name,
			@Param("departamentId") Long departamentId, Pageable pageable);
	...
	@Query(value = """
			...
			""", countQuery = """
			    ...
			    AND (:name IS NULL OR LOWER(p.name) LIKE LOWER(CONCAT('%', :name, '%')))
			""", nativeQuery = true)
	Page<EmployeeReportProjection> searchPeopleNameByOrId(@Param("name") String name, @Param("peopleId") Long peopleId,
			Pageable pageable);
