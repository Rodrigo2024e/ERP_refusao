...
public class MaterialResourceIT {
	...
	public void insertShouldReturn403WhenClientLogged() throws Exception {
		...
		ResultActions result = mockMvc.perform(post("/api/materials").header("Authorization", "Bearer " + clientToken)
				.content(jsonBody).contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON));
	...
	public void findAllShouldReturnAllResourcesPageadMaterialSortedByName() throws Exception {
		...
		ResultActions result = mockMvc.perform(get("/api/materials/report").header("Authorization", "Bearer " + adminToken)
	...
	public void findByIdShouldReturnAddressWhenIdExistsAndAdminRole() throws Exception {
		mockMvc.perform(get("/api/materials/{id}", existingId).header("Authorization", "Bearer " + adminToken)
	...
	public void insertShouldInsertResourceWhenAdminLoggedAndCorrectData() throws Exception {
		...
		MvcResult result = mockMvc
				.perform(post("/api/materials").header("Authorization", "Bearer " + adminToken).content(jsonBody)
	...
	public void insertShouldReturn422WhenAdminLoggedAndInvalidDescription() throws Exception {
		...
		ResultActions result = mockMvc.perform(post("/api/materials").header("Authorization", "Bearer " + adminToken)
				.content(jsonBody).contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON));
