...
//1
	...
	public void insertShouldReturn401WhenInvalidToken() throws Exception {
		...
		SectorDTO dto = new SectorDTO(null, "Produção", "Recebimento e classificação de sucata");
...
//3	
	...
	public void insertShouldInsertResourceWhenAdminLoggedAndCorrectData() throws Exception {
		...
		result.andExpect(jsonPath("$.setorNome").value("Gerência Industrial"));
		result.andExpect(jsonPath("$.processo").value("Administração"));
...
//4
	...
	public void insertShouldReturn422WhenAdminLoggedAndBlankSector() throws Exception {
		...
		result.andExpect(jsonPath("$.errors[0].fieldName").value("setorNome"));
